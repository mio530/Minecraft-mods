...
public class VisionConfigScreen extends Screen {
    ...
    private static final List<ModDef>  MODS = List.of(
        ...
        // Combat
        new ModDef("killAura",    "Kill Aura",      "Greife Entities an",        "Combat"),
        new ModDef("criticals",   "Criticals",      "Immer kritische Treffer",   "Combat"),
        new ModDef("autoClicker", "Auto Clicker",   "Automatisch klicken",       "Combat"),
        new ModDef("velocity",    "Velocity",       "Kein Knockback",            "Combat"),
        new ModDef("autoTotem",   "Auto Totem",     "Totem auto anlegen",        "Combat"),
        new ModDef("noHurtCam",   "NoHurtCam",      "Kein Kamera-Wackeln",       "Combat"),
        // Movement
        new ModDef("sprint",      "Sprint",         "Immer sprinten",            "Movement"),
        new ModDef("fly",         "Fly",            "Creative-Fliegen",          "Movement"),
        new ModDef("speed",       "Speed",          "Erhöhte Geschwindigkeit",   "Movement"),
        new ModDef("noFall",      "NoFall",         "Kein Fallschaden",          "Movement"),
        new ModDef("step",        "Step",           "Höhere Stufen erklimmen",   "Movement"),
        new ModDef("jesus",       "Jesus",          "Auf Wasser laufen",         "Movement"),
        new ModDef("noSlow",      "NoSlow",         "Kein Cobweb/Fluid-Slow",    "Movement"),
        new ModDef("scaffold",    "Scaffold",       "Auto-Brücke legen",         "Movement"),
        // Player
        new ModDef("autoEat",     "Auto Eat",       "Automatisch essen",         "Player"),
        new ModDef("antiHunger",  "AntiHunger",     "Kein Hungerverlust",        "Player"),
        new ModDef("antiPoison",  "AntiPoison",     "Entfernt Debuffs",          "Player"),
        new ModDef("antiAfk",     "AntiAFK",        "Verhindert AFK-Kick",       "Player"),
        // Render
        ...
        new ModDef("noFog",       "NoFog",          "Kein Nebel",                "Render"),
        new ModDef("noWeather",   "NoWeather",      "Kein Regen/Schnee",         "Render"),
        new ModDef("antiBlind",   "AntiBlind",      "Kein Blindness/Darkness",   "Render"),
